        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ofm_weighbridge_ticket = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    foreign_ticket = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ck_number = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_tickets_receiving_ticket_number",
                schema: "metal_link",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_tickets_receiving_company_id",
                schema: "metal_link",
                table: "tickets_receiving",
                column: "company_id");

            migrationBuilder.CreateIndex(
                name: "ix_tickets_receiving_site_id",
                schema: "metal_link",
                table: "tickets_receiving",
                column: "site_id");

            migrationBuilder.CreateIndex(
                name: "ix_tickets_receiving_customer_id",
                schema: "metal_link",
                table: "tickets_receiving",
                column: "customer_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_tickets_receiving_created_time",
                schema: "metal_link",
                table: "tickets_receiving",
                column: "created_time");

            // Create ticket_receiving_lines table
            migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_tickets_sending_ticket_number",
                schema: "metal_link",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_tickets_sending_company_id",
                schema: "metal_link",
                table: "tickets_sending",
                column: "company_id");

            migrationBuilder.CreateIndex(
                name: "ix_tickets_sending_site_id",
                schema: "metal_link",
                table: "tickets_sending",
                column: "site_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_tickets_sending_created_time",
                schema: "metal_link",
                table: "tickets_sending",
                column: "created_time");

            // Create ticket_sending_lines table
            migrationBuilder.CreateTable(
